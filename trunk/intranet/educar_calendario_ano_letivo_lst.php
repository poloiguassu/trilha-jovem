...
class clsIndexBase extends clsBase
{
  function Formular()
  {
    $this->SetTitulo($this->_instituicao . ' Trilha Jovem - Calendário Letivo');
    ...
    if (empty($lista)) {
      if ($nivel_usuario == 4) {
        ...
        if ($_POST) {
          ...
          $retorno .= '<tr><td colspan="2" align="center" class="formdktd">Selecione uma instituição para exibir o calendário</td></tr>';
        }
      }
    }
