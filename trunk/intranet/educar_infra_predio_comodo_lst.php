...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} Trilha Jovem - Cõmodos" );
		$this->processoAp = "574";
...
class indice extends clsListagem
{
	...
	function Gerar()
	{
		...
		$this->campoLista( "ref_cod_infra_comodo_funcao", "Função cômodo", $opcoes, $this->ref_cod_infra_comodo_funcao,"",false,"","","",false );
