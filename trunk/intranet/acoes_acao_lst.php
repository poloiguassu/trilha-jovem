...
class clsIndex extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} Sistema de Cadastro de Ações - Listagem de ações" );
		$this->processoAp = "551";
	}
}
...
class indice extends clsListagem
{
	function Gerar()
	{
		...
		// Filtros de Busca
		$this->campoTexto("cod_acao_governo","Código da ação",$cod_acao_governo,50,255);
		$this->campoTexto("nm_acao","Nome da ação",$nm_acao,50,255);
		...
		$this->addCabecalhos( array(  "Nome da ação", "Status") );
		// Paginador
		$limite = 10;
