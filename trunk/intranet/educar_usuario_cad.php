...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		$this->campoListaPesq( "cod_usuario_", "Usuário", $opcoes, $this->cod_usuario, "pesquisa_funcionario_lst.php", "", false, "", "", null, null, "", false, $parametros->serializaCampos() );
		...
		if( $excluiu )
		{
			...
			if ($lista_bibliotecas_usuario) {
				...
				foreach ($lista_bibliotecas_usuario as $usuario)
				{
					$obj_usuario_bib = new clsPmieducarBibliotecaUsuario($usuario['ref_cod_biblioteca'],$this->pessoa_logada);
					if(!$obj_usuario_bib->excluir()){
						echo "<!--\nErro ao excluir usuário da biblioteca\n-->";
						return false;
					}
				}
			}
