...
class indice extends clsDetalhe
{
	function Gerar()
	{
		...
		if( $strVersoes )
		{
			$this->addDetalhe( array( "Versões Anteriores", $strVersoes ) );
		}
		...
		{
			$this->addDetalhe( array( "Visivel" , "Este edital esta visível" ) );
		}
		
		$motivo_alteracao = str_replace( "\n", "<br>", $motivo_alteracao );
		$this->addDetalhe( array("Motivo da alteração", $motivo_alteracao ) );
