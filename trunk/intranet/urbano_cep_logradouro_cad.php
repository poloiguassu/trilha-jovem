...
class indice extends clsCadastro
{
  ...
  function Gerar()
  {
    ...
    if (class_exists('clsMunicipio')) {
      ...
      echo '<!--\nErro\nClasse clsMunicípio nao encontrada\n-->';
      $opcoes = array('' => 'Erro na geração');
    }
    ...
    {
      echo '<!--\nErro\nClasse clsLogradouro não encontrada\n-->';
      $opcoes = array('' => 'Erro na geração');
    }
  ...
  function Editar()
  {
    ...
    if (($this->idbai[0] != '') && ($this->cep[0] != '')) {
      ...
      $this->mensagem = 'É necessário adicionar pelo menos um CEP e bairro.<br>';
...
document.getElementById('sigla_uf').onchange = function() {
  ...
  campoMunicipio.options[0].text = 'Carregando municípios...';
