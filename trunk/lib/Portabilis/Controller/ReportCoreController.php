...
class Portabilis_Controller_ReportCoreController extends Core_Controller_Page_EditController
{
  ...
  function onValidationError() {
    $msg = Portabilis_String_Utils::toUtf8('O relatório não pode ser emitido, dica(s):\n\n');
    ...
    $msg = Portabilis_String_Utils::toUtf8($msg, array('escape' => false));
  ...
  function renderError($details = "") {
    ...
    $msg     = Portabilis_String_Utils::toUtf8('Ocorreu um erro ao emitir o relatório.') . '\n\n' . $details;
