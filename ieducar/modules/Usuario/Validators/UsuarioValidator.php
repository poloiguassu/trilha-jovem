...
class UsuarioValidator
{
                                             ...
                                             $matricula)
  {
    ...
    elseif ($newPassword != $confirmation)
      $messenger->append('A confirmação de senha não confere com a senha.', 'error');

    elseif (strpos($newPassword, $matricula) != false)
      $messenger->append('A senha informada é similar a sua matricula, informe outra senha.', 'error');
