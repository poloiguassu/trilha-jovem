...
class clsIndexBase extends clsBase
{
  function Formular()
  {
    $this->SetTitulo($this->_instituicao . ' Trilha Jovem - Aluno');
    $this->processoAp = 578;
  }
}
...
class indice extends clsCadastro
{
  ...
  function Gerar()
  {
    ...
    $this->campoTexto('nm_mae', 'Nome da Mãe',$this->nm_mae, 30, 255, FALSE);
    ...
    $this->campoNumero('numero', 'Número', $this->numero, 4, 6, FALSE, '',
      '', FALSE, FALSE, TRUE);
    ...
    $this->campoRadio('tipo_responsavel', 'Responsável', $opcoes, $this->tipo_responsavel);
    ...
    $this->campoLista('ref_cod_aluno_beneficio', 'Benefício', $lista_beneficio,
