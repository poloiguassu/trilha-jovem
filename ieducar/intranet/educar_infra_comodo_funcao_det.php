...
class clsIndexBase extends clsBase
{
	function Formular()
	{
		$this->SetTitulo( "{$this->_instituicao} i-Educar - Função Cômodo" );
		$this->processoAp = "572";
	}
}
...
class indice extends clsDetalhe
{
	...
	function Gerar()
	{
		...
		$this->titulo = "Função Cômodo  - Detalhe";
...
//		$registro = $tmp_obj->detalhe();
		...
		{
			$this->addDetalhe( array( "Função Cômodo", "{$registro["cod_infra_comodo_funcao"]}") );
		}
		...
		{
			$this->addDetalhe( array( "Descrição Função", "{$registro["desc_funcao"]}") );
		}
