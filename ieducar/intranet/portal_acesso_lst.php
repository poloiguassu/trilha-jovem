...
class indice extends clsListagem
{
	...
	function Gerar()
	{
		...
		// outros Filtros
		$this->campoData( "ultimo_sucesso_ini", "Data mínima do ultimo sucesso", $this->ultimo_sucesso_ini, false );
		$this->campoData( "ultimo_sucesso_fim", "Data máxima do ultimo sucesso", $this->ultimo_sucesso_fim, false );

		$this->campoData( "quinto_erro_ini", "Data mínima do quinto erro", $this->quinto_erro_ini, false );
		$this->campoData( "quinto_erro_fim", "Data máxima do quinto erro", $this->quinto_erro_fim, false );
