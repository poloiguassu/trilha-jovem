...
class clsIndexBase extends clsBase {
  function Formular()
  {
    $this->SetTitulo($this->_instituicao . ' Trilha Jovem - Funcionários Detalhamento');
    $this->processoAp = 635;
  }
}
...
class indice extends clsDetalhe
{
  ...
  function Gerar()
  {
    ...
    if ($registro['cod_servidor']) {
      $this->addDetalhe(array('Funcionário', $registro['cod_servidor']));
    }
    ...
    if ($obj_permissoes->permissao_cadastra(635, $this->pessoa_logada, 7)) {
      ...
      $this->array_botao[] = 'Alocar Funcionário';
      ...
      if ($lista) {
        $this->array_botao[] = 'Substituir Horário Funcionário';
