...
class indice extends clsCadastro
{
  ...
  function Gerar()
  {
    ...
    $this->campoLista('ref_cod_nivel_ensino', 'Nível de Ensino', $opcoes,
    ...
    $this->campoMonetario('carga_horaria', 'Carga Horária',
  ...
  function Excluir()
  {
    ...
    $excluiu = $obj->excluir();
    if ($excluiu) {
      $this->mensagem .= "Excusão realizada com sucesso.<br>";
      header("Location: educar_curso_lst.php");
      die();
    }
