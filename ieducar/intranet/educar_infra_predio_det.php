...
class indice extends clsDetalhe
{
	...
	function Gerar()
	{
		...
		{
			$this->addDetalhe( array( "Infra Prédio", "{$registro["cod_infra_predio"]}") );
		}
		...
		{
			$this->addDetalhe( array( "Nome Prédio", "{$registro["nm_predio"]}") );
		}
		if( $registro["desc_predio"] )
		{
			$this->addDetalhe( array( "Descrição do Prédio", "{$registro["desc_predio"]}") );
		}
