...
<tr class="r2c1">
	...
	<td align="right"><a href="index.php"><img src="imagens/nvp_bot_intra_calendario.png" width="79" height="21" border="0" alt="Calendario" title="Calendário"></a><a href="meusdados.php"><img src="imagens/nvp_bot_intra_dados.png" width="80" height="21" border="0" alt="Meus Dados" title="Meus dados"></a><a href="logof.php"><img src="imagens/nvp_bot_intra_logout.png" width="56" height="21" border="0" alt="Logout" title="Sair"></a><!--a href="http://www.google.com.br/" target="_blank"><img src="imagens/nvp_bot_internet.jpg" width="62" height="21" border="0" alt="Acessar Internet" title="Acessar a Web"></a--></td>
</tr>
<tr>
	<td colspan="3">
