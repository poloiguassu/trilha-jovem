...
class clsIndex extends clsBase
{
	function Formular()
	{
		...
		$this->SetTitulo( "{$this->_instituicao} Sistema de Cadastro de Ações - Notícias" );
		$this->processoAp = "551";
	}
}
 ...
 */
		...
		{				
			...
			$enviar = "isEmpty(\"Atenção nenhuma notícia foi selecionada, \\n para inserir uma nova notícia clique na lupa acima!\");";
			$tabela .= "<tr bgcolor=$cor align='center'><td>Nenhum notícia adicionada</td></tr>";
			
		}
		
		$tabela .= "</table>";
		
		$this->campoRotulo("tab", "Notícias", $tabela);
