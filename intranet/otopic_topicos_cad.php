...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		*/
		...
		{
			$this->campoRotulo("rt1", "<b>Selecione a reunião na qual o novo tópico sera criado</b>", "");
			$this->campoRadio( "radio", "Reuniões em andamento", $listaReuniaoAndamento, "" );
		}
	...
	function Novo() 
	{
		...
		if($cod_topico)
		{
			...
			$objEmail = new clsEmail( $grupo_pessoas, "[OpenTopic] - Novo Tópico", $corpo_email,"email_mailling_topic" );
			$objEmail->envia();
