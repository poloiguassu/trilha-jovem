...
<?	$pessoa_logada = $_SESSION['id_pessoa'];
	...
	if( $nivel_usuario == 1 || $cad_usuario )
	{
		...
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao,"getDuploEscolaBiblioteca();",null,null,null,$instituicao_desabilitado,$instituicao_obrigatorio);
		}
		else if ($get_escola && $get_curso && $get_matricula)
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao, "getMatricula();", null, null, null, $instituicao_desabilitado, $instituicao_obrigatorio );
		}
		else if ($get_escola && $get_curso )
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao, "getDuploEscolaCurso();", null, null, null, $instituicao_desabilitado, $instituicao_obrigatorio );
		}
		else if ($get_escola)
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao,"getEscola();",null,null,null,$instituicao_desabilitado,$instituicao_obrigatorio);
		}
		else if ($get_curso)
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao,"getCurso();",null,null,null,$instituicao_desabilitado,$instituicao_obrigatorio);
		}
		else if ($get_biblioteca)
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao,"getBiblioteca(1);",null,null,null,$instituicao_desabilitado,$instituicao_obrigatorio);
		}
		...
		{
			$this->campoLista( "ref_cod_instituicao", "Instituição Executora", $opcoes, $this->ref_cod_instituicao,"",null,null,null,$instituicao_desabilitado,$instituicao_obrigatorio);
		}
	}
	...
	{
		$opcoes_escola = array( "" => "Selecione uma instituição" );
		// EDITAR
		...
		if ($get_biblioteca)
		{
			$this->campoLista( "ref_cod_escola", "Instituição", $opcoes_escola, $this->ref_cod_escola,"getBiblioteca(2);",null,null,null,$escola_desabilitado,$escola_obrigatorio );
		}
		else
		{
			$this->campoLista( "ref_cod_escola", "Instituição", $opcoes_escola, $this->ref_cod_escola,null,null,null,null,$escola_desabilitado,$escola_obrigatorio );
		}
	}
	if ($get_curso)
	{
...
?>
	...
	function getEscola()
	{
		...
		campoEscola.options[0].text = 'Carregando Instituições';
	...
	function atualizaLstEscola(xml)
	{
		...
		campoEscola.options[0].text = 'Selecione uma Instituição';
		...
		{
			campoEscola.options[0].text = 'A instituição executora não possui nenhuma instituição cadastrada';
		}
...
?>
	...
	function atualizaLstCurso(xml)
	{
		...
		{
			campoCurso.options[0].text = 'A instituição não possui nenhum projeto';
		}
	}
<?
}
...
?>
	...
	function atualizaLstSerieMatricula(xml)
	{
		...
		{
			campoSerie.options[0].text = 'A instituição/projeto não possui nenhum eixo';
		}
	}
<?
}
...
?>
	...
	function atualizaLstSerie(xml)
	{
		...
		{
			campoSerie.options[0].text = 'O projeto não possui nenhum eixo ou todas as eixos já estã associadas a essa instituição';
		}
	}
<?
}
...
?>
	...
	function atualizaLstSerie(xml)
	{
		...
		{
			campoSerie.options[0].text = 'O curso não possui nenhum eixo';
		}
	}
<?
}
...
?>
	...
	function atualizaLstTurma(xml)
	{
		...
		{
			campoTurma.options[0].text = 'O eixo não possui nenhuma turma';
		}
