...
class clsIndexBase extends clsBase
{
  function Formular()
  {
    $this->SetTitulo($this->_instituicao . ' Trilha Jovem - Eixo');
    $this->processoAp = '585';
  }
}
...
class indice extends clsDetalhe
{
  ...
  function Gerar()
  {
    ...
    if ($registro['hora_inicio_intervalo']) {
      ...
      $this->addDetalhe(array('Hora de Início do Intervalo', $registro['hora_inicio_intervalo']));
    }

    if ($registro['hora_fim_intervalo']) {
      $registro['hora_fim_intervalo'] = date('H:i', strtotime($registro['hora_fim_intervalo']));
      $this->addDetalhe(array( 'Hora de Fim do Intervalo', $registro['hora_fim_intervalo']));
    }
