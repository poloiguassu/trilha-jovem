...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		$this->campoTexto("endereco", "Endereço", $this->endereco, 60, 255, true );
		$estados = array();
		$db = new clsBanco();
	...
	function Excluir()
	{
		...
		{
			$this->mensagem = "Esta empresa está associada a logs de downloads e não pode ser deletada.";
		}
		return false;
	}
